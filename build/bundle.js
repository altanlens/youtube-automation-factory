...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "youtube-automation-station:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkyoutube_automation_station"] = self["webpackChunkyoutube_automation_station"] || [];
...
const AIVideo = ({
  ...
  const scale = currentSubtitle ? (0,esm.interpolate)(
    currentTime,
  ...
  const opacity = currentSubtitle ? (0,esm.interpolate)(
    currentTime,
    [currentSubtitle.start, currentSubtitle.start + 0.3, currentSubtitle.start + currentSubtitle.duration - 0.3, currentSubtitle.start + currentSubtitle.duration],
    [0, 1, 1, 0]
  ) : 0;
  const springValue = (0,esm.spring)({
    frame,
    fps,
    config: {
      damping: 200
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#000" }, children: [
    audioUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Audio,
      {
        src: audioUrl.startsWith("http") ? audioUrl : (0,esm.staticFile)(audioUrl.replace(/^.*\//, "")),
        volume: 1
      }
    ),
    (currentSubtitle == null ? void 0 : currentSubtitle.imageUrl) && /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    ...
    currentSubtitle && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.AbsoluteFill,
      {
        style: {
...
const HelloWorld = ({ titleText, titleColor }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "white" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Title, { titleText, titleColor }) }) });
};

// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(6540);
;// ./src/excalidraw/parser.ts

class ExcalidrawParser {
  // Convert Excalidraw JSON to SVG using built-in Excalidraw functions
  static async parseToSVG(scene, options = {}) {
    const {
      width = 800,
      height = 600,
      background = "transparent",
  ...
  static async convertElementsToSVG(elements, options) {
  ...
  static createRectangleSVG(element) {
  ...
  static createEllipseSVG(element) {
    const { x, y, width, height, strokeColor, backgroundColor, strokeWidth, opacity } = element;
    const cx = x + width / 2;
    const cy = y + height / 2;
    const rx = width / 2;
  ...
  static validateScene(scene) {
    ...
    return scene.elements.every(
      (element) => element && typeof element.id === "string" && typeof element.type === "string" && typeof element.x === "number" && typeof element.y === "number"
    );
  }
  // Get bounding box of all elements
  static getBoundingBox(elements) {
...
;// ./src/excalidraw/roughRenderer.ts
...
class RoughRenderer {
  ...
  constructor(width = 800, height = 600) {
    ...
    this.roughCanvas = at.canvas(this.canvas);
  }
  // Convert Excalidraw elements to hand-drawn SVG using Rough.js
  static async renderToSVG(elements, options = {}) {
    const {
      width = 800,
      height = 600,
      background = "transparent",
    ...
    for (const element of elements) {
      ...
      const elementStyle = {
        ...
        fill: element.backgroundColor === "transparent" ? void 0 : element.backgroundColor,
  ...
  static createRoughElement(roughSvg, element, style) {
    switch (element.type) {
      case "rectangle":
  ...
  static createArrowhead(x, y, fromX, fromY, style) {
...
;// ./src/excalidraw/ExcalidrawRenderer.tsx
...
const ExcalidrawRenderer = ({
  ...
  var _a;
  const frame = (0,esm.useCurrentFrame)();
  const [svgContent, setSvgContent] = (0,react.useState)("");
  const [isLoading, setIsLoading] = (0,react.useState)(true);
  if (!scene) {
    console.log("ExcalidrawRenderer: No scene data provided");
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#f0f0f0", ...style }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", height: "100%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { children: "No scene data provided" }) }) });
  }
  console.log("ExcalidrawRenderer: Scene received", {
    elements: ((_a = scene.elements) == null ? void 0 : _a.length) || 0,
    frame,
    animated,
    useRoughStyle
  });
  const relativeFrame = Math.max(0, frame - startFrame);
  const animationDuration = (0,react.useMemo)(() => {
    const speedMap = {
      slow: duration * 1.5,
      normal: duration,
      fast: duration * 0.5
    ...
    const generateSVG = async () => {
      ...
      try {
        ...
        if (animated && animationType === "progressive-draw") {
          ...
          const visibleElementCount = Math.floor(progress * scene.elements.length);
          elementsToRender = scene.elements.slice(0, visibleElementCount + 1);
        }
        const sceneToRender = {
          ...scene,
        ...
        if (useRoughStyle) {
          ...
          svg = await RoughRenderer.renderToSVG(sceneToRender.elements, {
            width,
            height,
            background: ((_a2 = scene.appState) == null ? void 0 : _a2.viewBackgroundColor) || "transparent",
            roughStyle
          });
        } else {
          svg = await ExcalidrawParser.parseToSVG(sceneToRender, {
            width,
            height,
            background: ((_b = scene.appState) == null ? void 0 : _b.viewBackgroundColor) || "transparent"
          });
        }
        setSvgContent(svg);
      } catch (error) {
  ...
  const animationProgress = animated ? (0,esm.interpolate)(
    relativeFrame,
    [0, animationDuration],
    [0, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
  ...
  if (isLoading) {
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.AbsoluteFill,
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: "#666", fontSize: 16 }, children: "Loading Excalidraw scene..." })
      }
    );
  }
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
...
const ExcalidrawTextScene = ({
  ...
  return /* @__PURE__ */ jsxs("div", { style: { textAlign: "center", ...style }, children: [
    /* @__PURE__ */ jsx("h2", { style: { marginBottom: 20, color: "#333" }, children: title }),
    /* @__PURE__ */ jsx(
      ExcalidrawRenderer,
      {
        scene,
...
;// ./src/compositions/SimpleExcalidraw.tsx



const SimpleExcalidraw = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#ffffff", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
    fontSize: 48,
    fontWeight: "bold",
    color: "#1e1e1e",
    textAlign: "center"
  }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { children: "Excalidraw Test" }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width: "200", height: "100", style: { border: "2px solid #000" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: "100", cy: "50", r: "40", fill: "#ff6b6b", stroke: "#000", strokeWidth: "3" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("text", { x: "100", y: "55", textAnchor: "middle", fontSize: "16", fill: "#000", children: "TEST" })
    ] })
  ] }) });
};

;// ./src/compositions/SmarterVideo.tsx
...
const AnimatedText = ({ text, animation, delay = 0 }) => {
  ...
  const animationStyles = {
    "fade-in": {
      opacity: progress,
      transform: `translateY(${(0,esm.interpolate)(progress, [0, 1], [20, 0])}px)`
    },
    "slide-up": {
      transform: `translateY(${(0,esm.interpolate)(progress, [0, 1], [50, 0])}px)`,
      opacity: progress
    },
    "zoom-in": {
      transform: `scale(${(0,esm.interpolate)(progress, [0, 1], [0.8, 1])})`,
      opacity: progress
    },
    "morph": {
      transform: `scale(${(0,esm.interpolate)(progress, [0, 1], [0.9, 1])}) rotate(${(0,esm.interpolate)(progress, [0, 1], [-2, 0])}deg)`,
      opacity: progress
    },
    "stack-up": {
    ...
    "glow": {
      opacity: progress,
      textShadow: `0 0 ${(0,esm.interpolate)(progress, [0, 1], [0, 20])}px rgba(59, 130, 246, 0.8)`
    }
  };
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        ...
        fontSize: "80px",
        opacity: progress,
        filter: `hue-rotate(${(0,esm.interpolate)(progress, [0, 1], [0, 360])}deg)`
      },
      children: "\u{1F9E0}"
    }
  );
};
const BookIcon = ({ progress }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        ...
        top: "25%",
        left: "50%",
        transform: `translateX(-50%) scale(${(0,esm.interpolate)(progress, [0, 1], [0.5, 1])})`,
        fontSize: "60px",
        opacity: progress
      },
      children: "\u{1F4DA}"
...
const StatGraph = ({ progress }) => {
  const barHeight = (0,esm.interpolate)(progress, [0, 1], [20, 120]);
...
const NeuralNetwork = ({ progress }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      children: [...Array(6)].map((_, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            position: "absolute",
            ...
            opacity: (0,esm.interpolate)(progress, [0, 1], [0.3, 1]),
            transform: `scale(${(0,esm.interpolate)(progress, [0, 1], [0.5, 1])})`,
            boxShadow: `0 0 ${(0,esm.interpolate)(progress, [0, 1], [0, 15])}px #3b82f6`
          }
        },
        i
      ))
...
const SmarterVideo = () => {
  ...
  const renderVisual = (scene, progress) => {
    switch (scene.visuals) {
      case "brain":
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(BrainIcon, { progress });
      case "research":
        return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: "20%", left: "50%", transform: "translateX(-50%)", fontSize: "60px", opacity: progress }, children: "\u{1F4CA}\u{1F4C8}\u{1F4CB}" });
      case "stats":
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(StatGraph, { progress });
      case "neural":
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(NeuralNetwork, { progress });
      case "books":
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(BookIcon, { progress });
      case "book":
        return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: "20%", left: "50%", transform: "translateX(-50%)", fontSize: "80px", opacity: progress, filter: `drop-shadow(0 0 ${(0,esm.interpolate)(progress, [0, 1], [0, 20])}px #f59e0b)` }, children: "\u{1F4D6}" });
      default:
        return null;
    }
  };
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              right: 0,
              bottom: 0,
              background: `radial-gradient(circle at ${(0,esm.interpolate)(frame, [0, 60 * fps], [20, 80])}% ${(0,esm.interpolate)(frame, [0, 60 * fps], [30, 70])}%, rgba(59, 130, 246, 0.1) 0%, transparent 50%)`
            }
          }
        ),
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 974).then(__webpack_require__.bind(__webpack_require__, 4974)).then(({ StudioInternals }) => {
